...
class UserStreamController {
    static getStreamsHot = async (req: Request, res: Response) => {
        ...
        return new OK({
            metadata: result,
            message: "Lấy danh sách stream HOT thành công!"
        }).send(res);
    }
    ...
    static getAllStreamBySub = async (req: Request, res: Response) => {
        const creatorid = req.params.creator_id;
        const page = parseInt(req.query.page as string);
        const limit = parseInt(req.query.limit as string);
        
        const result = await UserStreamService.getAllStreamBySub(parseInt(creatorid), page, limit);
        return new OK({
            metadata: result,
    ...
    static getStreamUrlByCreatorId = async (req: Request, res: Response) => {
        ...
        return new OK({
            ...
            message: "Lấy đường dẫn livestream thành công!"
        }).send(res);
    }
    ...
    static getListStreamOfCreatorFollowed = async (req: ReqEntity, res: Response) => {
        ...
        return new OK({
            metadata: result,
            message: "Lấy danh sách livestream của nhà sáng tạo nội dung đã theo dõi thành công!"
        }).send(res);
    }
}
